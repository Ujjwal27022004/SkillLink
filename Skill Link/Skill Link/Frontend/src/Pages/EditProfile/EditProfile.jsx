        ...
        <div className="register_section mb-3">
          ...
          >
            <Tab eventKey="registration" title="Registration">
              ...
              {/* Skills to learn */}
              <div>
                <label style={{ color: "black", marginTop: "20px" }}>Skills To Learn</label>
                <br />
                <Form.Select
                  aria-label="Default select example"
                  value={skillsToLearn}
            ...
            {/* <Tab eventKey="Preview" title="Confirm Details">
              <div>
                <h3 style={{ color: "black", marginBottom: "20px" }} className="link w-100 text-center">
                  Preview of the Form
                </h3>
                <div
                ...
                >
                  ...
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Name:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Email ID:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Username:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Portfolio Link:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Github Link:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Linkedin Link:</span>
                    <span
                      style={{
                        width: "70vw",
                        alignItems: "center",
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Skills Proficient At:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Skills To Learn:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "black" }}>Bio:</span>
